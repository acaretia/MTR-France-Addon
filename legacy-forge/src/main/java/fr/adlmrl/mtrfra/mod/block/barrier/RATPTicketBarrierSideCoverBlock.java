...
public class RATPTicketBarrierSideCoverBlock extends DirectionalBlock {
    ...
    public RATPTicketBarrierSideCoverBlock() {
        super(Blocks.createDefaultBlockSettings(true, state -> 5));
    }
    ...
    public void onPlaced2(World world, BlockPos pos, BlockState state, LivingEntity placer, ItemStack itemStack) {
        ...
        if (!world.isClient()) {
            world.setBlockState(pos.up(), ModBlocks.RATP_TICKET_BARRIER_UPPER.get().getDefaultState(), 3);
        }
    }
    ...
    public void onBreak2(World world, BlockPos pos, BlockState state, PlayerEntity player) {
        if (!world.isClient()) {
            world.setBlockState(pos.up(), org.mtr.mapping.holder.Blocks.getAirMapped().getDefaultState(), 35);
        }
