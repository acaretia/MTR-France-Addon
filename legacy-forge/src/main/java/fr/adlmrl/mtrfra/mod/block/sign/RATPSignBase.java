...
public abstract class RATPSignBase extends DirectionalBlock implements BlockWithEntity, HasBoundingBox {
    ...
    protected RATPSignBase(BlockSettings blockSettings, int maxCategory, float textY, float textZ, double[] boundingBox, boolean doubleSided) {
        super(blockSettings);
    ...
    public static class BlockEntityBase extends BlockEntityExtension {
        ...
        public BlockEntityBase(BlockPos pos, BlockState state) {
            super(fr.adlmrl.mtrfra.mod.registry.ModBlockEntities.RATP_SIGN.get(), pos, state);
        }
