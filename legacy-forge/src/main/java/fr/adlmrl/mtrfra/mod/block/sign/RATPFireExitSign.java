...
public class RATPFireExitSign extends DirectionalBlock {

    public RATPFireExitSign(BlockSettings settings) {
        super(settings);
    }

    @Override
    public VoxelShape getOutlineShape2(BlockState state, BlockView view, BlockPos pos, ShapeContext context) {
        return IBlock.getVoxelShapeByDirection(4, 2, 15, 9, 12, 16, IBlock.getStatePropertySafe(state, FACING));
    }
