...
import fr.adlmrl.mtrfra.mod.block.panneau.PanneauRATPRenderer;
...
public final class ModBlockEntityRenderers {
    ...
    public static void registerClient() {
        ...
        MTRFRARegistryClient.REGISTRY_CLIENT.registerBlockEntityRenderer(ModBlockEntities.PANNEAU_RATP, PanneauRATPRenderer::new);
    }
