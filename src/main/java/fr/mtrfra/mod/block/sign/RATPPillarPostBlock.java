...
public class RATPPillarPostBlock extends DirectionalBlock {

    private static final double[] BOUNDING_BOX = {6.5, 0, 12.5, 9.5, 16, 13.5};

    public RATPPillarPostBlock(BlockSettings blockSettings) {
        super(blockSettings);
    }
